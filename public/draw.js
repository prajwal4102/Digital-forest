...
// Only the kinds listed here get a card on the drawing board. Everything else
// (chicken 'bird', snake 'slitherer', flower 'plant', 'toucan', 'hawk') stays
// fully working in the codebase — add a kind back to this list to offer it.
...
let ws = null;
let wsReady = false;
// a server-restarted signal means this pad may be showing an outdated animal
